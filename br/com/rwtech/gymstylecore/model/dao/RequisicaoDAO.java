...
public class RequisicaoDAO
{
    ...
    {
        String sql = "INSERT INTO REQUISICOES (data_hora, parametro, referencia, status, id_operador_fk, tipo_requisicao_fk, destino) VALUES (?,?,?,?,?,?,?) returning id_requisicao";
        PreparedStatement pstm = null;
        Connection conn = ConnectionManager.getInstance().getConnection();
        try
        {
